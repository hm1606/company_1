...
-- -----------------------------------------------------
-- Table `Company`.`ExcepcionCita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Company`.`ExcepcionCita` (
  `idExcepcionCita` INT NOT NULL AUTO_INCREMENT,
  `idExcepcionHorario` INT NULL,
  `idCitas` INT NULL,
  PRIMARY KEY (`idExcepcionCita`))
ENGINE = InnoDB;
